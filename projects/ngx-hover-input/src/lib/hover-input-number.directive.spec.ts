...
@Component({
	...
	template: `
		<div>
			...
			<div id="box1" (hiHoverInputNumber)="value1 = $event">
				<div id="value1">{{ value1 }}</div>
				<input id="input1" type="text" />
				<textarea id="textarea1"></textarea>
				<summary id="summary1"></summary>
			</div>
			<div id="box2" (hiHoverInputNumber)="value2 = $event">
				<div id="value2">{{ value2 }}</div>
			</div>
			<div id="box3" (hiHoverInputNumber)="value3 = $event">
				<div id="value3">{{ value3 }}</div>
				<div id="box4" (hiHoverInputNumber)="value4 = $event">
...
describe('HoverInputNumberDirective', () => {
	...
	beforeEach(() => {
		TestBed.configureTestingModule({
			declarations: [ContainerComponent, HoverInputNumberDirective],
			providers: [
				HoverInputService,
